...
function isInternalWorkspaceDependency(name) {
	// phi-code ships its internal packages unscoped ("phi-code-ai", "phi-code-agent", …)
	// plus the published CLI under the @phi-code-admin scope.
	return name.startsWith("phi-code-") || name.startsWith("@phi-code-admin/");
}
