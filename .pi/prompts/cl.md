...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/uglyswap/phi-code/issues/123))`
- External: `Added bar ([#456](https://github.com/uglyswap/phi-code/pull/456) by [@user](https://github.com/user))`
