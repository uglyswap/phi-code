...
import { CONFIG_DIR_NAME, getAgentDir, parseFrontmatter } from "@phi-code-admin/phi-code";
...
function findNearestProjectAgentsDir(cwd: string): string | null {
	let currentDir = cwd;
	while (true) {
		// CONFIG_DIR_NAME resolves to ".phi" here, so the subagent and the phi
		// orchestrator read the same project agents source (".phi/agents",
		// matching ~/.phi/agent/agents for user scope).
