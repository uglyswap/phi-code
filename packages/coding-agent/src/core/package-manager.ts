...
/**
 * Settings patterns are portable data: they are written to settings.json and matched
 * with minimatch, which treats "\\" as an escape character. A Windows-separated
 * pattern therefore never matches the resource it was meant to disable.
 */
