...
describe("normalizeChangelogLinks", () => {
	test("rewrites package-relative changelog links to tag-pinned GitHub source links", () => {
		...
		expect(normalizeChangelogLinks(markdown, entry)).toBe(
			[
				"[Project Trust](https://github.com/uglyswap/phi-code/blob/v0.79.0/packages/coding-agent/README.md#project-trust)",
				"[Extensions](https://github.com/uglyswap/phi-code/blob/v0.79.0/packages/coding-agent/docs/extensions.md#project_trust)",
				"[Examples](https://github.com/uglyswap/phi-code/tree/v0.79.0/packages/coding-agent/examples/extensions/)",
				"[Root README](https://github.com/uglyswap/phi-code/blob/v0.79.0/README.md#supply-chain-hardening)",
			].join("\n"),
		);
	});
	...
	test("canonicalizes old repository URLs without changing external links", () => {
		const markdown = [
			"[#5167](https://github.com/uglyswap/phi-code/pull/5167)",
		...
		expect(normalizeChangelogLinks(markdown, "0.79.0")).toBe(
			[
				"[#5167](https://github.com/uglyswap/phi-code/pull/5167)",
				"[#4163](https://github.com/uglyswap/phi-code/issues/4163)",
				"[Agent README](https://github.com/uglyswap/phi-code/blob/v0.79.0/packages/agent/README.md)",
				"[External](https://example.com/docs)",
				"[Local anchor](#settings)",
			].join("\n"),
		);
