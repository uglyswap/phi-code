...
import type { FauxModelDefinition, FauxProviderRegistration, FauxResponseStep, Model } from "phi-code-ai/compat";
import { registerFauxProvider, streamSimple } from "phi-code-ai/compat";
