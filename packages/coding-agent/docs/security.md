...
To report a security issue, follow the repository [Security Policy](https://github.com/uglyswap/phi-code/blob/main/SECURITY.md). Do not open a public issue for security-sensitive reports.
