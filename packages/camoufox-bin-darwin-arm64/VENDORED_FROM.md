...
| Upstream asset | `camoufox-135.0.1-beta.24-mac.arm64.zip` |
...
gh release download v135.0.1-beta.24 -R daijro/camoufox \
    --pattern 'camoufox-135.0.1-beta.24-mac.arm64.zip' \
    --output .binaries-cache/camoufox-135.0.1-beta.24-mac.arm64.zip
node scripts/build-camoufox-bin-packages.mjs darwin-arm64
```
